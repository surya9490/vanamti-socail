...
function SignupPageInner() {
  ...
  // Hooks first (Rules of Hooks) — the invite-only early return
  // below must not come before any hook call, so we declare state
  // unconditionally even when we won't render the form.
