...
export interface Message {
   ...
   * `status === 'failed'`; never cleared by a later status.
   * Migration 028 introduced code/title/message (TEXT); migration 060
   * added `error_details` for the parsed error_data.details (upstream
   * #535). We stringify code to keep the DB column TEXT-typed.
   */
